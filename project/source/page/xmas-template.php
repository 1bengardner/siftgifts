...
<!DOCTYPE html>
<html>
  <?php define('TITLE', ucwords(strtolower($user->name))."'s Lottery Ticket"); ?>
  ...
  <body>
    ...
    <div class="center">
      ...
      ?>
      <h2 style="margin: 0;"><?php echo ucwords(strtolower($user->name)); ?>, welcome to the<span style="color: #b03; text-shadow: 0.05em 0.05em 0.15em #270;"> Christmas </span>lottery!</span></h2>
      ...
      <div class="widget" style="display: inline-block; padding: 1em; border-radius: 2em; margin: 1em;">
        ...
        <div id="reroll-container" style="margin-top: 1em;">
          <a id="reroll" onclick="reroll();" href="#swap" style="font-size: 1.1em">🎲 Swap your ticket</a>
        </div>
        <?php
        }
        ?>
  ...
  <script>
    ...
    function reroll() {
      ...
      rq.open("POST", "../../action/xmas-issue-lottery-ticket", true);
        ...
        if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
          ...
          dance(
            ...
            function() {
              ...
              document.getElementById("reroll").innerHTML = "🎲 Swap again&hellip;";
    ...
    if (document.getElementById("countdown")) {
      ...
      const timeLeft = `<?php echo include '../action/xmas-get-draw-time.php'; ?>`;
