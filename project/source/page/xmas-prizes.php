...
?>
  <details <?php if (!isset($_SESSION['seen prizes'])) { $_SESSION['seen prizes'] = true; echo 'open'; } ?> class="widget" style="display: inline-block; padding: 1em; margin: 0 0 1em 0; border-radius: 2em; color: #761616; background-color: #f6f9f6;"><summary style="cursor: pointer;">Prizes</summary>
    <div>
