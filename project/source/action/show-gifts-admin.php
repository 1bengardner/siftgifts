...
<div class="widget gift-widget focused">
  <div>
    <div class="right no-wrap">
      ...
      <button gift="<?php echo $var; ?>" id="remove-<?php echo $var; ?>" class="delete-placeholder" type="button" value="❌" onclick="remove(this.getAttribute('gift'), '<?php echo addslashes(htmlentities($gift->name)); ?>');"></button>
