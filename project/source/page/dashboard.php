  ...
  <body>
    ...
    <div class="center">
      <div>
        ...
        <p>Share your wishlist:<span class="unbreakable"><input class="wishlist-link" disabled id="foo" type="url" value='<?php echo $wishlist; ?>'><button class="clipboard" onclick="navigator.clipboard.writeText('<?php echo $wishlist; ?>')">📋</button></span></p>
      </div>
      <div class="monkey">
        <h1>
          <?php
